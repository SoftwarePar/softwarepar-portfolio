...
export const metadata: Metadata = {
  ...
  description:
    'Premium interactive enterprise AI operations demo by SoftwarePar: workflow orchestration, autonomous agents, human approvals, runtime telemetry and governance.',
};
